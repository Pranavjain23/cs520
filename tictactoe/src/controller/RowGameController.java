...
public class RowGameController {
	...
	gameView.playerturn.setEditable(false);
	gameModel.movesLeft--;
	...
	if(gameModel.getPlayer().equals(Player.PLAYER_1)) {
		...
		// gameView.gameBoardView.updateBlock(gameModel,0,0);
		gameView.update(gameModel);
		...
		// gameView.gameBoardView.updateBlock(gameModel,0,1);
		gameView.update(gameModel);
		gameModel.setPlayer(Player.PLAYER_2);
		if(gameModel.movesLeft<7) {
		...
		// gameView.gameBoardView.updateBlock(gameModel,0,2);
		gameView.update(gameModel);
		gameModel.setPlayer(Player.PLAYER_2);
		if(gameModel.movesLeft<7) {
		...
		// gameView.gameBoardView.updateBlock(gameModel,1,0);
		gameView.update(gameModel);
		gameModel.setPlayer(Player.PLAYER_2);
		if(gameModel.movesLeft<7) {
		...
		// gameView.gameBoardView.updateBlock(gameModel,1,1);
		gameView.update(gameModel);
		gameModel.setPlayer(Player.PLAYER_2);
		if(gameModel.movesLeft<7) {
		...
		// gameView.gameBoardView.updateBlock(gameModel,1,2);
		gameView.update(gameModel);
		gameModel.setPlayer(Player.PLAYER_2);
		if(gameModel.movesLeft<7) {
		...
		// gameView.gameBoardView.updateBlock(gameModel,2,0);
		gameView.update(gameModel);
		gameModel.setPlayer(Player.PLAYER_2);
		if(gameModel.movesLeft<7) {
		...
		// gameView.gameBoardView.updateBlock(gameModel,2,1);
		gameView.update(gameModel);
		gameModel.setPlayer(Player.PLAYER_2);
		if(gameModel.movesLeft<7) {
		...
		// gameView.gameBoardView.updateBlock(gameModel,2,2);
		gameView.update(gameModel);
		gameModel.setPlayer(Player.PLAYER_2);
		if(gameModel.movesLeft<7) {
	...
	for(int row = 0;row<3;row++) {
	    for(int column = 0;column<3;column++) {
		gameView.gameBoardView.blocks[row][column].setEnabled(false);
	    }
	}
    }
